...
High-load-friendly **gaming platform** (v1.0.7): real-time leaderboard via NATS + WebSockets, shop economy, JWT auth, target design ~10k RPS. v.1.0.8 incoming soon (30.08.2026)
